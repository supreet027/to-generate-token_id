...
router.get('/', function(_req, res) {
    res.render('work', { title: 'Enter your mobile number:', mobile_no: '' });
});
        ...
        try {
            if (error) {
                ...
                if (rows.length > 0) {
                    ...
                    res.render('success', { title: 'Generated token_id', token_id: token_id });
                } else {
                        ...
                        if (err) {
                            ...
                            database.query(selectQuery, function(err, rows, _fields) {
                                if (err) {
                                    ...
                                    const token_id = rows[0].token_id;
                                    res.render('success', { title: 'Success', token_id: token_id });
                                }
                            });
                        }
                    });
